...
By default, this script will log summaries to ./output/retrain_logs directory

Visualize the summaries with this command:

tensorboard --logdir ./output/retrain_logs
...
tensorflow_model_server --port=9000 --model_name=my_image_classifier \
    --model_base_path=./output/saved_models/
```
"""
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--checkpoint_path',
      type=str,
      default='./output/_retrain_checkpoint',
